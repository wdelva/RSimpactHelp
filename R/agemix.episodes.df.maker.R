#' Create dataframe of relationship episodes for agemixing analysis.
#'
#' Produces a dataframe of relationship episodes from list created by \code{\link{readthedata}}.
#'
...
agemix.episodes.df.maker <- function(datalist) {
