...
#' @return a list with the transmission networks data ( each of them considering different sampling/removal dates), as required by the epi2tree2 function.
#'         with flags for all diagnosed individuals (0), died and non diagnosed (-1), and alive and non diagnosed (1)
#' @examples
#' transm.ls <- transmNetworkBuilder.diff2(datalist = datalist,endpoint = 40)
#' @note
...
transmNetworkBuilder.diff2 <- function(datalist = datalist, endpoint = 40){
