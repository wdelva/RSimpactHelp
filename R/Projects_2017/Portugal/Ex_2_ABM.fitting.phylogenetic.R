...
rm(list = ls())
setwd("/home/david/Dropbox/Fitting_Simpact/FitEpiPhylo/EX_2/")
...
if(comp == "win"){dirname <- "~/MaxART/RSimpactHelp"}else if(comp=="lin"){
  dirname <- "~/Dropbox/Fitting_Simpact/FitEpiPhylo/EX_2/"}else if(comp=="chpc"){
...
target.variables <- c("phylo.alpha", "phylo.beta", "R0")
