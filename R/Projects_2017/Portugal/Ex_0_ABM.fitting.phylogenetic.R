...
rm(list = ls())
setwd("/home/david/Dropbox/Fitting_Simpact/FitEpiPhylo/Ex_0/")
...
if(comp == "win"){dirname <- "~/MaxART/RSimpactHelp"}else if(comp=="lin"){
  dirname <- "~/Dropbox/Fitting_Simpact/FitEpiPhylo/Ex_0/"}else if(comp=="chpc"){
...
filename.run <- paste0(dirname,"/","SummaryOutPut-df-phylo-exp_0-",min.chunk,"-",max.chunk,".csv")
