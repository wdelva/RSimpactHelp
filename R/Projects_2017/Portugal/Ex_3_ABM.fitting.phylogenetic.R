...
rm(list = ls())
setwd("/home/david/Dropbox/Fitting_Simpact/FitEpiPhylo/EX_3/")
...
if(comp == "win"){dirname <- "~/MaxART/RSimpactHelp"}else if(comp=="lin"){
  dirname <- "~/Dropbox/Fitting_Simpact/FitEpiPhylo/EX_3/"}else if(comp=="chpc"){
...
filename.run <- paste0(dirname,"/","SummaryOutPut-df-phylo-exp_3-",min.chunk,"-",max.chunk,".csv")
