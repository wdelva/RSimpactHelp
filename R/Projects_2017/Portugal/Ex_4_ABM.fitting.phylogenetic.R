...
rm(list = ls())
setwd("/home/david/Dropbox/Fitting_Simpact/FitEpiPhylo/EX_4/")
...
filename.run <- paste0(dirname,"/","SummaryOutPut-df-phylo-exp_4-",min.chunk,"-",max.chunk,".csv")
