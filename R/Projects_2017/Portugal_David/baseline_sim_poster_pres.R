...
propeties.trans.net <- properties_network(graph = test.graph)
...
properties.epi.tree <- properties_tree(tree = epi.tree)
...
RF.dist(tree1, tree2, normalize = FALSE, check.labels = T,
        rooted = T)
...
transNet.yrs.Old <- ga.graph # delete_edges(ga.graph, E(ga.graph)[weight>=10])

transNet.full <- ga.graph


seq.sim.size_full <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_72.fasta")
...
prop.built.net <- properties_network(graph = built.net.full)

prop.phylo.tree <- properties_tree(tree = tree.sim.full)
...
seq.sim.size_5 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_5.fasta")
tree.dat5 <- phyDat(seq.sim.size_5, type = "DNA")
tree.ml5 <- dist.ml(tree.dat5)
tree.sim5 <- upgma(tree.ml5)
keep.rand.5 <- c("57 ", "61 ", "38 ", "44 ", "54 ")
...
seq.sim.size_10 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_10.fasta")
tree.dat10 <- phyDat(seq.sim.size_10, type = "DNA")
tree.ml10 <- dist.ml(tree.dat10)
tree.sim10 <- upgma(tree.ml10)
keep.rand.10 <- c("57 ", "61 ", "38 ", "44 ",
                  "54 ", "14 ", "32 ", "48 ", "3 ",  "5 ")
...
seq.sim.size_20 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_20.fasta")
tree.dat20 <- phyDat(seq.sim.size_20, type = "DNA")
tree.ml20 <- dist.ml(tree.dat20)
tree.sim20 <- upgma(tree.ml20)
keep.rand.20 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 " , "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ")
...
# delete_vertices(transNet.yrs.Old, V(transNet.yrs.Old)[-match(as.numeric(keep.rand.20), V(transNet.yrs.Old))])
...
seq.sim.size_25 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_25.fasta")
tree.dat25 <- phyDat(seq.sim.size_25, type = "DNA")
tree.ml25 <- dist.ml(tree.dat25)
tree.sim25 <- upgma(tree.ml25)
keep.rand.25 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 " , "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ", "71 ", "43 ", "49 ", "50 ", "55 ")
...
seq.sim.size_35 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_35.fasta")
tree.dat35 <- phyDat(seq.sim.size_35, type = "DNA")
tree.ml35 <- dist.ml(tree.dat35)
tree.sim35 <- upgma(tree.ml35)
keep.rand.35 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 " , "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ", "71 ", "43 ", "49 ", "50 ",
                  "55 ", "12 ", "15 ", "31 ", "35 ", "69 ",
...
seq.sim.size_40 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_40.fasta")
tree.dat40 <- phyDat(seq.sim.size_40, type = "DNA")
tree.ml40 <- dist.ml(tree.dat40)
tree.sim40 <- upgma(tree.ml40)
keep.rand.40 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ", "32 ",
                  "48 ", "3 " , "5 ",  "58 ", "39 ", "56 ", "60 ",
...
seq.sim.size_50 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_50.fasta")
tree.dat50 <- phyDat(seq.sim.size_50, type = "DNA")
tree.ml50 <- dist.ml(tree.dat50)
tree.sim50 <- upgma(tree.ml50)
keep.rand.50 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ", "32 ",
                  "48 ", "3 " , "5 ",  "58 ", "39 ", "56 ", "60 ",
                  "59 ", "67 ", "62 ", "33 ", "26 ", "68 ", "71 ",
                  "43 ", "49 ", "50 ", "55 ", "12 ", "15 ", "31 ",
                  "35 ", "69 ", "37 ", "45 ", "70 ", "42 ", "53 ",
                  "63 ", "36 ", "4 ",  "19 ", "64 ", "46 ", "20 ",
                  "65 ", "22 ", "29 ", "40 ", "52 ", "0 " , "24 ", "23 ")
...
# Size 55
seq.sim.size_55 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_55.fasta")
tree.dat55 <- phyDat(seq.sim.size_55, type = "DNA")
tree.ml55 <- dist.ml(tree.dat55)
tree.sim55 <- upgma(tree.ml55)
keep.rand.55 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 ",  "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ", "71 ", "43 ", "49 ", "50 ",
                  "55 ", "12 ", "15 ", "31 ", "35 ", "69 ",
...
seq.sim.size_65 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_65.fasta")
tree.dat65 <- phyDat(seq.sim.size_65, type = "DNA")
tree.ml65 <- dist.ml(tree.dat65)
tree.sim65 <- upgma(tree.ml65)
keep.rand.65 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 " , "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ", "71 ", "43 ", "49 ", "50 ",
                  "55 ", "12 ", "15 ", "31 ", "35 ", "69 ",
...
seq.sim.size_70 <- read.FASTA("~/Dropbox/Niyukuri/Abstract_SACEMA_Research_Days_2017/check/baseline_seq/size_70.fasta")
tree.dat70 <- phyDat(seq.sim.size_70, type = "DNA")
tree.ml70 <- dist.ml(tree.dat70)
tree.sim70 <- upgma(tree.ml70)
keep.rand.70 <- c("57 ", "61 ", "38 ", "44 ", "54 ", "14 ",
                  "32 ", "48 ", "3 ",  "5 " , "58 ", "39 ",
                  "56 ", "60 ", "59 ", "67 ", "62 ", "33 ",
                  "26 ", "68 ", "71 ", "43 ", "49 ", "50 ",
                  "55 ", "12 ", "15 ", "31 ", "35 ", "69 ",
