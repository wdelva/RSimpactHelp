...
#' @param simulation.start the simulation start from which all intervention time will be calculated
...
intervention.introduced <- function(simulation.type = "simpact-cyan", simulation.start = "1970-03-31"){
