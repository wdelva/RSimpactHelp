...
lhs.df$agegap.man.mu <- qunif(rlhs[ , 7], min = 0, max = 4)
lhs.df$agegap.woman.mu <- qunif(rlhs[ , 8], min = 0, max = 4)
lhs.df$agegap.man.sigma <- qunif(rlhs[ , 9], min = 0.5, max = 2)
lhs.df$agegap.woman.sigma <- qunif(rlhs[ , 10], min = 0.5, max = 2)
