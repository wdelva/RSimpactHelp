...
testinput$population.nummen <- 1000 #2000
testinput$population.numwomen <- 1000 #2000
...
test.output <- function(testoutput){
  ...
  ART.cov.15.50 <- ARTcov$pointprevalence[3] # among men and women
...
```{r plotOutput, echo=TRUE, message = FALSE, cache = FALSE}
# Running the simpact4emulation function with error catcher in a loop
head(inANDout.df)
```
