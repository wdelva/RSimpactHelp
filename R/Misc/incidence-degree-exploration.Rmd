...
```{r getmodelready, echo=FALSE, message = FALSE}
...
testinput$population.nummen <- 400 #1000 #2000
testinput$population.numwomen <- 400 #1000 #2000
...
```{r ARTintervention, echo=FALSE, message = FALSE}
...
# Gradual increase in CD4 threshold. in 2007:200. in 2010:350. in 2013:
...
```{r simpactTestrun, echo=TRUE, message = FALSE, cache = FALSE}
...
# Running the simpact4emulation function with error catcher in a loop
save(inANDout.df, agedist.data.frame, testinput, iv, file = "/Users/delvaw/Documents/RSimpactHelper/R/Misc/incidence-degree-exploration.100.RData")
...
# Running the simpact4emulation function with error catcher in a loop
incidence.degree.exploration.100.loaded <- load(file = "/Users/delvaw/Documents/RSimpactHelper/R/Misc/incidence-degree-exploration.100.RData")
#save(inANDout.df, file = "/Users/delvaw/Documents/RSimpactHelper/R/Misc/incidence-degree-exploration.100.RData")

# How many runs gave non-NA output?
nrow(inANDout.df[complete.cases(inANDout.df), ]) # 53
...
pairs(matched.df[, 20:21],
      xlim = c(0, 1),
      ylim = c(0, 1))
matchedplusHarling.df <- rbind(matched.df,
                               c(0.075, 0.013))
matchedplusHarling.df$Harling <- c(rep(0, nrow(matched.df)), 1)

pairs(matchedplusHarling.df[, 20:21],
