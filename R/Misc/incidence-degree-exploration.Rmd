...
inANDout.100.df <- cbind.data.frame(sim.id = 1:design.points,
                                rlhs,
                                lhs.df,
...
for (sim.id in inANDout.100.df$sim.id){
  ...
  inANDout.100.df[sim.id, 22:30] <- as.numeric(out.test.list$summStats)
