...
maxart.endtime <- as.Date("2025-11-03")
...
############  Hhohho incidence ##############################################
#Data was collected between September 2014 and November 2016 [MaxART study]:
#TimeTo = between (2014-09-01 - 2016-11-03)
...
hhohho.prev <- read.table(
  text="F.val   Fu.val   Fl.val  M.val   Mu.val  Ml.val   FM.val   FMu.val  FMl.val
  A0.150    NA  NA  NA  NA  NA  NA  NA  NA  NA
  A15.25    NA  NA  NA  NA  NA  NA  NA  NA  NA
  A15.49    NA  NA  NA  NA  NA  NA  NA  NA  NA
  A15.150   NA  NA  NA  NA  NA  NA  NA  NA  NA
  A25.34    NA  NA  NA  NA  NA  NA  NA  NA  NA
...
target.variables <- c(tar.name(hhohho.growth.rate, "gr"),
                      tar.name(max.art.initiated.all, "art.cov"),
                      tar.name(hhohho.inci.2016, "inci"),
                      tar.name(max.vl.none.suppression.all, "vl.sup"),
...
target.values <- c(tar.value(hhohho.growth.rate), tar.value(max.art.initiated.all),
                   tar.value(hhohho.inci.2016),tar.value(max.vl.none.suppression.all),
                   tar.value(hhohho.prev), tar.value(hhohho.shims2.prev),
