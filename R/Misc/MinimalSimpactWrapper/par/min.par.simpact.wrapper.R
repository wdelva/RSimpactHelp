...
source("R/Misc/MinimalSimpactWrapper/par/min.par.simpact.simulation.R")
#local source file#
#dirname <- "~/Documents/100000.Pre.Hhoho.OutFiles"

#indicate if False = initial simulation or TRUE = from a file
...
#Run the simulation.
training.df <- min.par.simulation.wrapper(set.seed.id = 1,   #what seed to use
                                          ...
                                          datalist = cal.datalist, #cal.datalist
