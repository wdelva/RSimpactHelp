...
#' pattern.modeller. It contains two elements. The first is a
...
#' @docType data
#'
#' @usage data(agemixpatdat)
#'
#' @format The first dataframe in the list has 16579 rows and 26 variables. The
#'   second dataframe has 1 row and 14 variables. More detailed descriptions of
#'   the contents of the dataframes can be found in
#'   \code{\link{pattern.modeller}}
