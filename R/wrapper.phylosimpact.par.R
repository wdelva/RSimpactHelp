...
#' Wrapper for pre and post simpact simulation
#'
#' @param inputvector Simpact input parameters to setup the simulation
...
wrapper.phylosimpact.par <- function(inputvector, work.dir){


  # Working directory where we find seq-gen, FastTree, and HIV seed file hiv.seq.C.pol.j.fasta

  # work.dir <- "/home/david/RSimpactHelp/R/Tests/TEST_17_4_2018/"

  # work.dir <- "/user/data/gent/vsc400/vsc40070/phylo/"
