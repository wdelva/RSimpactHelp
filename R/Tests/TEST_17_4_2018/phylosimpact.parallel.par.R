...
# source the warpper in working directory

source("/home/david/RSimpactHelp/R/Tests/TEST_17_4_2018/wrapper.phylosimpact.par.R")
...
features.matrix <- simpact.parallel(model = wrapper.phylosimpact.par,
                                    actual.input.matrix = inputmatrix,
                                    seed_count = 123,
                                    n_cluster = 1)
