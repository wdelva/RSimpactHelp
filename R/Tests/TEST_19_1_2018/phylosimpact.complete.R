...
setwd("/home/david/RSimpactHelp/R/Tests/TEST_19_1_2018/")
...
destDir <- "/home/david/RSimpactHelp/R/Tests/TEST_19_1_2018/temp" # laptop
...
cfg.list <- input.params.creator(population.eyecap.fraction = 0.2, #0.21,#1,
  ...
  population.nummen = 200, #3000, #600, # 3800, #2500,
...
dirseqgen <- "/home/david/RSimpactHelp/R/Tests/TEST_19_1_2018/seqgen"
...
dirfasttree <- "/home/david/RSimpactHelp/R/Tests/TEST_19_1_2018/Fasttree"
...
dates <- format(date_decimal(c(mrsd, first.div)), "%Y-%m-%d")
