  ...
  if(min.val <= 0){
    ...
    if(length(TransmEventsCountVector)==1){
      ...
      if(clust==TRUE){
        ...
        system(paste0(paste0(paste0(seq.gen.tool)," -mGTR -f 0.3906, 0.1752, 0.2201, 0.2142  -a 0.6250 -g 4 -i 0.2130  -r 1.9803, 9.4404, 0.9423, 0.8770, 11.6367, 1.0000 -s 0.00475  -n1 -k",seq.rand,"< ",in.seq.gen.file," -z",seedid," > ", out.seq.gen.file)))
